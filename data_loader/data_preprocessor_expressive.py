...
class DataPreprocessor:
    def __init__(self, clip_lmdb_dir, out_lmdb_dir, n_poses, subdivision_stride,
        ...
        self.src_lmdb_env = lmdb.open(clip_lmdb_dir, readonly=True, lock=False) # clip_lmdb_dir = train
    ...
    def run(self):
        ...
        for key, value in cursor:
            ...
            for clip_idx, clip in enumerate(clips):
                filtered_result = self._sample_from_clip(eid, clip)
        ...
        with self.dst_lmdb_env.begin() as txn:
            ...
            print('no. of total output sequences: ', self.n_out_samples)
    ...
    def _sample_from_clip(self, eid, clip):
        clip_skeleton = clip['skeletons']
